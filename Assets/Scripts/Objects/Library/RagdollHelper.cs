...
{
    [ContextMenu("setRagdolledTrue")]
    public void setRagdolledTrue()
    {
        ragdolled = true;
    }

    [ContextMenu("setRagdolledFalse")]
    public void setRagdolledFalse()
    {
        ragdolled = false;
    }
    ...
    public float ragdollToMecanimBlendTime = 0f;
    ...
    void LateUpdate()
    {
        ...
        //try { anim.SetBool("GetUpFromBelly", false); } catch (Exception) { }
        //try { anim.SetBool("GetUpFromBack", false); } catch (Exception) { }
        ...
        if (state == RagdollState.blendToAnim)
        {
            if (Time.time <= ragdollingEndTime + mecanimToGetUpTransitionTime)
            {
                ...
                newRootPosition = ragdolledHipPosition;
