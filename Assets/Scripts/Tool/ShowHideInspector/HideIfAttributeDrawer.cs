...
public class HideIfAttributeDrawer : PropertyDrawer
{
  ...
  BindingFlags.NonPublic | BindingFlags.Public)
    ...
    {
        var hideIfAttribute = this.attribute as HideIfAttribute;
        var target = property.serializedObject.targetObject;
        List<bool> conditionValues = new List<bool>();

        foreach (var condition in hideIfAttribute.Conditions)
        {
        ...
        {
            bool met;
            if (hideIfAttribute.Operator == ConditionOperator.And)
            {
                met = true;
                 ...
                 label)
    {
        ...
        if (!meetsCondition && hideIfAttribute.Action ==
           ...
           label)
    {
        ...
        var hideIfAttribute = this.attribute as HideIfAttribute;
        if (hideIfAttribute.Action == ActionOnConditionFail.DontDraw)
        {
            return;
        }
        else if (hideIfAttribute.Action == ActionOnConditionFail.JustDisable)
        {
