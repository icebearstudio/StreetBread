...
namespace UnityEngine.UI.Extensions {
	...
	public class UIVerticalScroller : MonoBehaviour {
		...
		public UIVerticalScroller (RectTransform scrollingPanel, GameObject[] arrayOfElements, RectTransform center, float coefficient) {
		...
		public UIVerticalScroller (RectTransform scrollingPanel, GameObject[] arrayOfElements, RectTransform center, float coefficient, float minCoefficient) {
			_scrollingPanel = scrollingPanel;
			_arrayOfElements = arrayOfElements;
			_center = center;
			this.coefficient = coefficient;
		...
		public UIVerticalScroller (RectTransform scrollingPanel, GameObject[] arrayOfElements, RectTransform center, float coefficient, float minCoefficient, int starElement) {
			_scrollingPanel = scrollingPanel;
			_arrayOfElements = arrayOfElements;
			_center = center;
			this.coefficient = coefficient;
		...
		public void Start () {
			...
			deltaY = _arrayOfElements [starElement].GetComponent<RectTransform> ().localPosition.y;
			Vector2 startPosition = new Vector2 (_scrollingPanel.anchoredPosition.x, -deltaY);
			//startPosition = new Vector2 (_scrollingPanel.anchoredPosition.x, _center.sizeDelta.y / 2f);
		...
		private void ScrollingElements (float position) {
			float newY = Mathf.Lerp (_scrollingPanel.anchoredPosition.y, position, Time.deltaTime * 10f);
