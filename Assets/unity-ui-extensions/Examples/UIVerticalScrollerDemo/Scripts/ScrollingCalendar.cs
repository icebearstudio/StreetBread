...
namespace UnityEngine.UI.Extensions.Examples {
	public class ScrollingCalendar : MonoBehaviour {
		...
		public void Awake () {
			...
			monthsVerticalScroller = new UIVerticalScroller (monthsScrollingPanel, monthsButtons, monthCenter, 100f);
			yearsVerticalScroller = new UIVerticalScroller (yearsScrollingPanel, yearsButtons, yearsCenter, 100f);
			daysVerticalScroller = new UIVerticalScroller (daysScrollingPanel, daysButtons, daysCenter, 100f);
