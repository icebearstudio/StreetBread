...
public class iTweenLocalRotationToNoneReset : iTweenEditor
{
    ...
    public override void iTweenPlay()
    {
        ...
        this.transform.localEulerAngles = valueFrom;
    ...
    {
        this.transform.localEulerAngles = valueFrom + _transition * value;
    }
}